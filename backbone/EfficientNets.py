...
class BlockDecoder(object):
    ...
    def _decode_block_string(block_string):
        ...
        ops = block_string.split('_')具有坚实的计算机科学与技术、计算机系统结构、并行与分布式系统，高性能并行计算、并行文件系统等方面基础知识和工程经验；
熟练掌握C/C++语言，熟悉Linux内核和Windows、Linux平台下C语言集成开发环境，具有异构平台下的算法设计、实现和优化能力，熟悉MPI、OpenMP、PGAS等并行编程模型；
具备较丰富的项目组织协调经验和跨单位项目合作经验，参与撰写过多篇学术论文、项目申请、项目年度进展报告和项目结题报告。
        options = {}
        for op in ops:
