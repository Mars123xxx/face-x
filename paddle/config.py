configurations = {
    1: dict(
        ...
        BACKBONE_NAME='ppResNet_50',
        # support: ['ppResNet_50','ResNet_50', 'ResNet_101', 'ResNet_152', 'IR_50', 'IR_101', 'IR_152', 'IR_SE_50', 'IR_SE_101', 'IR_SE_152']
        ...
        SAVE_QUANT_MODEL=False,
        # model quant_aware training refer https://paddle-lite.readthedocs.io/zh/latest/user_guides/quant_aware.html
    ),
}
